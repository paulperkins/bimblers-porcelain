...
?>
			<div class="next-ride" id="<?php echo $map_id; ?>" data-rwgps-id="<?php echo $bimblers_ride->rwgps; ?>" style="<?php echo $map_style; ?>">
			</div><!--/.next-ride -->
<?php
...
<div class="post-content<?php echo $thumb_class; ?>">
	<div class="post-title-wrapper">
		...
		<?php if ( !is_single() ) { 
			...
			if ($bimblers_featured) { ?>
			Our next ride: <a href="<?php echo $bimblers_ride->url; ?>"><?php echo $bimblers_ride->title; ?></a>
			<?php 
			} else { ?>
...
<?php } ?>
	...
	if ($bimblers_featured) {$excerpt = $bimblers_ride->excerpt; }
	...
	if ( !$excerpt && pexeto_option( 'post_summary' )!='excerpt' || is_single() ) {
		...
		if ($bimblers_featured) {
			echo $bimblers_ride->excerpt;?>
		<br>
		<a href="<?php echo $bimblers_ride->url; ?>" class="read-more">
